 ...
 */
export const sound = { engine: null };
// ── the four letters ───────────────────────────────────────────────────────
...
export const states = LETTERS.map(() => ({
...
export function autoGain(i, v, dt) {
    const g = AGC[i];
